...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/8c55f8c77b77b4e4304c2.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url=f"http://t.me/Professor_Ashu_bot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Luna❤️](http://t.me/Professor_Ashu_bot):**
**RoBot:** `{bot_state}`
**UserBot:** `Alive`
...
**Profiles:** [BOT](http://t.me/Professor_Ashu_bot) | [UBOT](https://t.me/Professer_Ashu)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Professor Stats",
            thumb_url="https://telegra.ph/file/8c55f8c77b77b4e4304c2.jpg",
            input_message_content=InputTextMessageContent(
...
async def about_function(answers):
    ...
    msg = f"""
[Professor ✨](http://t.me/Professor_Ashu_bot) 
   Maintained by [X](https://t.me/Professer_Ashu)
Built with using python-telegram-bot v13.7 Running on Python 3.9.7
"""
    answers.append(
        InlineQueryResultArticle(
            title="About",
            description="About Professor",
            thumb_url="https://telegra.ph/file/8c55f8c77b77b4e4304c2.jpg",
            input_message_content=InputTextMessageContent(
                msg, disable_web_page_preview=True
            ),
