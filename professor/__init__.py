...
if ENV:
    ...
    from professor.config import Development as Config
...
pbot = Client("professor", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from professor.modules.helper_funcs.handlers import (
