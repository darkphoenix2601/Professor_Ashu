...
from professor.__main__ import STATS, TOKEN, USER_INFO
import professor.modules.sql.userinfo_sql as sql
from professor.modules.disable import DisableAbleCommandHandler
from professor.modules.sql.global_bans_sql import is_user_gbanned
from professor.modules.sql.afk_sql import is_afk, check_afk_status
from professor.modules.sql.users_sql import get_user_num_chats
from professor.modules.helper_funcs.chat_status import sudo_plus
from professor.modules.helper_funcs.extraction import extract_user
from professor import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
