...
import professor.modules.sql.global_bans_sql as gban_sql
import professor.modules.sql.users_sql as user_sql
from professor import DEV_USERS, OWNER_ID, dispatcher
