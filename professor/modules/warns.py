...
import telegram
from professor import TIGERS, WOLVES, dispatcher
from professor.modules.disable import DisableAbleCommandHandler
from professor.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from professor.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from professor.modules.helper_funcs.string_handling import split_quotes
from professor.modules.log_channel import loggable
from professor.modules.sql import warns_sql as sql
