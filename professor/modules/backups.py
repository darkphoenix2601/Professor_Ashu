...
import professor.modules.sql.notes_sql as sql
from professor import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from professor.__main__ import DATA_IMPORT
from professor.modules.helper_funcs.chat_status import user_admin
from professor.modules.helper_funcs.alternate import typing_action

# from professor.modules.rules import get_rules
import professor.modules.sql.rules_sql as rulessql

# from professor.modules.sql import warns_sql as warnssql
import professor.modules.sql.blacklist_sql as blacklistsql
from professor.modules.sql import disable_sql as disabledsql

# from professor.modules.sql import cust_filters_sql as filtersql
# import professor.modules.sql.welcome_sql as welcsql
import professor.modules.sql.locks_sql as locksql
from professor.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("professor{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("professor{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `professor-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("professor{}.backup".format(chat_id))  # Cleaning file
